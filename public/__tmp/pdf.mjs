...
/******/ var __webpack_modules__ = {
  ...
  /***/ 4644: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
    ...
    var NATIVE_ARRAY_BUFFER_VIEWS =
      NATIVE_ARRAY_BUFFER && !!setPrototypeOf && classof(globalThis.opera) !== 'Opera'
        ...
        if (!TypedArray[KEY] || forced) {
          ...
          try {
            return defineBuiltIn(
              TypedArray,
              KEY,
              forced ? property : (NATIVE_ARRAY_BUFFER_VIEWS && TypedArray[KEY]) || property
            )
          } catch (error) {
            /* empty */
          }
...
*/
  ...
  /***/ 8004: /***/ (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    ...
    var INCORRECT =
      !setMethodAcceptSetLike('intersection') ||
      fails(function () {
  ...
  /***/ 7467: /***/ (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
  ...
  /***/ 4732: /***/ (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    var ArrayBufferViewCore = __webpack_require__(4644)
    var uncurryThis = __webpack_require__(9504)
    var aCallable = __webpack_require__(9306)
  ...
  /***/ 8992: /***/ (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
  ...
  /***/ 3215: /***/ (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    // TODO: Remove from `core-js@4`
  ...
  /***/ 4520: /***/ (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    // TODO: Remove from `core-js@4`
  ...
  /***/ 670: /***/ (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    // TODO: Remove from `core-js@4`
  ...
  /***/ 1454: /***/ (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    // TODO: Remove from `core-js@4`
  ...
  /***/ 7550: /***/ (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    // TODO: Remove from `core-js@4`
        ...
        if (nodeIsArray) {
          ...
          for (i = 0; i < len; i++) {
            internalizeProperty(
              val,
              i,
              internalize(val, '' + i, reviver, i < elementRecordsLen ? nodes[i] : undefined)
            )
          }
        } else {
  ...
  /***/ 5247: /***/ (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    // TODO: Remove from `core-js@4`
...
var web_url_search_params_size = __webpack_require__(8721) // ./src/shared/util.js
const isNodeJS =
...
var esnext_json_parse = __webpack_require__(8335) // ./src/display/display_utils.js
...
class AnnotationEditorUIManager {
  ...
  #selectionChange() {
    ...
    if (!this.isShiftKeyDown) {
      const activeLayer =
        this.#mode === AnnotationEditorType.HIGHLIGHT ? this.#getLayerForTextLayer(textLayer) : null
...
class AnnotationEditor {
  ...
  get _hasBeenResized() {
    return (
      !!this.#initialRect &&
      (this.#initialRect[2] !== this.width || this.#initialRect[3] !== this.height)
    )
  }
  getBaseTranslation() {
  ...
  #resizerPointermove(name, event) {
    ...
    if (isDiagonal) {
      ...
      ratioX =
        Math.max(minWidth, Math.min(1, Math.abs(oppositePoint[0] - point[0] - deltaX))) / savedWidth
    } else {
      ratioY =
...
var esnext_iterator_filter = __webpack_require__(4520) // ./src/display/filter_factory.js
...
function getDocument(src = {}) {
  ...
  const isImageDecoderSupported =
    typeof src.isImageDecoderSupported === 'boolean'
      ...
      : !isNodeJS && (util_FeatureTest.platform.isFirefox || !globalThis.chrome)
...
var esnext_iterator_flat_map = __webpack_require__(670) // ./src/shared/scripting_utils.js
...
class DrawingEditor extends AnnotationEditor {
  ...
  _onResizing() {
    this.parent?.drawLayer.updateProperties(
      this._drawId,
      DrawingEditor._mergeSVGProperties(
        this.#drawOutlines.getPathResizingSVGProperties(this.#convertToDrawSpace()),
        {
          bbox: this.#rotateBox()
        }
      )
  ...
  _onResized() {
    this.parent?.drawLayer.updateProperties(
      this._drawId,
      DrawingEditor._mergeSVGProperties(
        this.#drawOutlines.getPathResizedSVGProperties(this.#convertToDrawSpace()),
        {
          bbox: this.#rotateBox()
        }
      )
  ...
  static startDrawing(parent, uiManager, _isLTR, event) {
    ...
    if (DrawingEditor.#currentDraw) {
      parent.drawLayer.updateProperties(
        this._currentDrawId,
        DrawingEditor.#currentDraw.startNew(x, y, parentWidth, parentHeight, rotation)
      )
      return
    }
  ...
  serialize([pageX, pageY, pageWidth, pageHeight], isForCopying) {
    ...
    for (const { line, points } of this.#lines) {
      serializedLines.push(
        rescaleFn(line, tx, ty, sx, sy, isForCopying ? new Array(line.length) : null)
      )
      serializedPoints.push(
        rescaleFn(points, tx, ty, sx, sy, isForCopying ? new Array(points.length) : null)
      )
    }
    return {
